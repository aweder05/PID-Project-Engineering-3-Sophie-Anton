...
* [Project Proposal](#Project_Proposal)
    ...
    * [Criteria and Constraints](#criteria_and_constraints)
        * [Success Statement](#success_statement)
* [Planning](#Planning)
* [Materials](Materials)
* [CAD](#CAD)
...
|---- |--- | 
|Have a box with a spinning banana where RPM is printed on an LCD on the front of the box.  |PID Tuning may not be 100% perfectly tuned | 
...
One thing we learned from doing this project, is that creativity is the first aspect the be depleted when the partner(s) are stressed. At first we planned to use a banana as the wheel to interrupt the photointerrupter, but the banana wasn't symmetric, causing the interrupts to be irregular. We had to reprint the wheel, and regretfully trash the banana idea. My partner ad I had to get rid of the one aspect of the project that was personal to us. In the future, we would have redesigned the banana, and had the two points that interrupt the POT to me on the same line.
